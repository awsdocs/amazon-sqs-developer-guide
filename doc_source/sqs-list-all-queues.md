...
When you create a queue, it can take a short time for the queue to propagate throughout Amazon SQS\. In this tutorial you'll learn how to confirm your queue's existence by listing all queues in the current region\.

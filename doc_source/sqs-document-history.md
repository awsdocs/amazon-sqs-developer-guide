...
| --- | --- | 
| February 11, 2020 |  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-document-history.html)  | 
...
| November 27, 2019 | Corrected the prerequisites listed in the [Tutorial: Configuring a queue to trigger an AWS Lambda function](sqs-configure-lambda-function-trigger.md) section\. | 
...
| October 16, 2019 | Rewrote the [Configure KMS permissions for AWS services ](sqs-key-management.md#compatibility-with-aws-services) section\. | 
...
| September 24, 2019 | Added the following statement to the [Configuring AWS KMS permissions](sqs-key-management.md#sqs-what-permissions-for-sse) section: The call to kms:Decryptis to verify the integrity of the data key before using it\. | 
...
| June 28, 2018 | Created the [Tutorial: Configuring a queue to trigger an AWS Lambda function](sqs-configure-lambda-function-trigger.md) tutorial\. | 
...
| January 22, 2018 | Added the [Configure KMS permissions for AWS services ](sqs-key-management.md#compatibility-with-aws-services) section\. | 
